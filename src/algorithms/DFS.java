...
public class DFS {
    ...
    public DFS(Graph graph, String startNode, String goalNode) {
        this.graph = graph;
    ...
    private void goalPath(String goalNode) {
        ...
        System.out.println(String.format("DFS total distance to goal from %s to %s: %.2f miles" , this.startNode, this.goalNode, pathCost * 0.621371));
